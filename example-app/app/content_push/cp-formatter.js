...
(function () {
  ...
  var HTML_TAG_REGEX = new RegExp('</?[^<>]+?/?>', 'gm');  /* regexp to retrieve the domain from a URL */
  ...
  var CpFormatter = {
    ...
    cleanHTML: function (text) {
      if (text) {
        text = text.replace(HTML_TAG_REGEX, '');  /* replace nbsp */
                                                  /* replace nbsp */
                                                  /* replace nbsp */
                                                  /* replace nbsp */
                                                  /* replace nbsp */
        ...
        /* replace nbsp */
        /* replace nbsp */
        text = text.replace(/&nbsp;/g, ' ');  /* replace unicode entities */
