...
(function () {
  ...
  var KeywordSelector = function (ArrayUtils) {
    this.ArrayUtils = ArrayUtils;  /* hash of all keywords extracted from the document so far
                                          with this format:
                                          {
                                            "keyword text": [
                                              {
    ...
    /* hash of all keywords extracted from the document so far
        ...
        */
    this.keywords = {};  /* array of keywords associated with the currently-visible part
    ...
    /* array of keywords associated with the currently-visible part
     ...
     the active keywords which are selected according to the
     algorithm in getCurrentKeywords() */
    this.activeKeywords = [];  /* "width" across the set of current active keywords; this
  ...
  KeywordSelector.prototype.checkKeywordInfoChanged = function (newKeywords) {
    var currentKeywords = this.getCurrentKeywords();  /* no keywords yet, so definitely a change */
