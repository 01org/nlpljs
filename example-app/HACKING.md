...
1.  The `content_script/cs-rehost-page.js` content script runs. This
...
1.  The panel listens for `newkeywordinfo` events. When they are received,
...
1.  This cycle continues (e.g. user types or scrolls, context changes,
