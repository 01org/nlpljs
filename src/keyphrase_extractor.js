...
(function () {
  var makeKeywordExtractor = function (postagger) {
    ...
    var textGraph = function () {
      ...
      var constructGraph = function (from, to) {
      ...
      return {
        construct: function (text) {
          ...
          constructGraph(0, annotatedTokens.length);
  ...
  if (typeof define !== 'undefined' && define.amd) {
    define(['postagger'], function (postagger) {
      return makeKeywordExtractor(postagger);
    });
  } else {
    var postagger = require('./postagger');
    module.exports = makeKeywordExtractor(postagger);
  }
})();
